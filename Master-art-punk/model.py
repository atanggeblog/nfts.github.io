...
color_data = get_model.get_main_colors(settings.color_data_path)
...
box = get_model.box_method(color_data_sort.tolist(), len(color_data_sort) // settings.box_number)
#print([get_model.rgb_to_hex(i[:3]) for i in box])
